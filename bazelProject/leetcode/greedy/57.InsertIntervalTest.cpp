...
TEST(case_1,content)
{
    ...
    intervals = {};
    EXPECT_EQ(insert2(intervals, in), ans);

    intervals = {};
    EXPECT_EQ(insert3(intervals, in), ans);
}
...
{
    vector<vector<int>> intervals = {{1, 3}, {6, 9}}, ans = {{1,5}, {6,9}};
    vector<int> in = {2, 5};
    EXPECT_EQ(insert(intervals, in), ans);
...
{
    vector<vector<int>> intervals = {{1, 5}}, ans = {{1,7}};
    vector<int> in = {2, 7};
    EXPECT_EQ(insert(intervals, in), ans);
